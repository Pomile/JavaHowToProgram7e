...
package com.deteil.howtoprogram.examples.ch28.BlackjackGame.build.generated.wsimport.client.com.deitel.jhtp7.ch28.blackjackclient;
 ...
 * generated in the com.deitel.jhtp7.ch28.blackjackclient package. 
...
public class ObjectFactory {
    ...
    private final static QName _ShuffleResponse_QNAME = new QName("http://blackjack.ch28.jhtp7.deitel.com/", "shuffleResponse");
    private final static QName _DealCardResponse_QNAME = new QName("http://blackjack.ch28.jhtp7.deitel.com/", "dealCardResponse");
    private final static QName _GetHandValue_QNAME = new QName("http://blackjack.ch28.jhtp7.deitel.com/", "getHandValue");
    private final static QName _DealCard_QNAME = new QName("http://blackjack.ch28.jhtp7.deitel.com/", "dealCard");
    private final static QName _GetHandValueResponse_QNAME = new QName("http://blackjack.ch28.jhtp7.deitel.com/", "getHandValueResponse");
    private final static QName _Shuffle_QNAME = new QName("http://blackjack.ch28.jhtp7.deitel.com/", "shuffle");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.deitel.jhtp7.ch28.blackjackclient
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://blackjack.ch28.jhtp7.deitel.com/", name = "shuffleResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://blackjack.ch28.jhtp7.deitel.com/", name = "dealCardResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://blackjack.ch28.jhtp7.deitel.com/", name = "getHandValue")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://blackjack.ch28.jhtp7.deitel.com/", name = "dealCard")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://blackjack.ch28.jhtp7.deitel.com/", name = "getHandValueResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://blackjack.ch28.jhtp7.deitel.com/", name = "shuffle")
