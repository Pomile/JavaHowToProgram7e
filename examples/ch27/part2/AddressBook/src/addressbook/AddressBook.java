...
// Page bean that suggests names in the AutoComplete Text Field.
package com.deteil.howtoprogram.examples.ch27.part2.AddressBook.src.addressbook;
...
public class AddressBook extends AbstractPageBean 
{
   ...
   private AutoCompleteComponent nameAutoComplete = new AutoCompleteComponent();
