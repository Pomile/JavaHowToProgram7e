...
function openEula(url){
	openWin = window.open(url, 'Win', 'height=440,width=600,toolbar=no,resizable=no,scrollbars=yes');
    openWin.focus();
}
...
rollData[4] = new roData('html/images/addnlBP.gif','html/images/addnlBP_on.gif');
